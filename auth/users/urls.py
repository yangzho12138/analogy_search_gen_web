...
from users.views import IssueLogView
from users.views import CommentReplyInfoView
...
urlpatterns = [
    ...
    url(r'^api/users/commentReplyInfo', CommentReplyInfoView.as_view()),
    url(r'^api/users/comment', CommentAnalogyView.as_view()),
    url(r'^api/users/issueInfo', IssueLogView.as_view()),
