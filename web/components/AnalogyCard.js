...
const issueOptions = ["Offensive Content", "Spam", "Irrelevant", "Other"];
...
const AnalogyCard = ({ searchResult, isCard, userInfo, isCollected }) => {
  ...
  const { doRequest: doRequestReport, errors: reportError } = useRequest({
    ...
    onSuccess: (data) => {
      alert(
        "Thank you for your report, a memeber of our team will review the analogy shortly."
      );
    },
  });
  ...
  const { doRequest: doRequestGetComments, errors: getCommentsError } =
    useRequest({
  ...
  const { doRequest: doRequestCollect, errors: collectError } = useRequest({
    url: assignment_url + "/api/assignment/analogy",
    method: "put",
    body: {
      analogy_id: searchResult.pid,
    },
    onSuccess: (data) => {
      alert("Collected!");
  ...
  useEffect(() => {
    if (collectError) {
      setErrors(collectError);
    }
  }, [collectError]);

  const { doRequest: doRequestCancelCollect, errors: cancelCollectError } =
    useRequest({
      url: assignment_url + "/api/assignment/analogy",
      method: "delete",
      body: {
  ...
  useEffect(() => {
    if (cancelCollectError) {
      setErrors(cancelCollectError);
    }
  }, [cancelCollectError]);
                      ...
                      {comments.map((comment, index) => {
                        return (
                          <Comment
                            key={index}
                            comment={comment}
                            replyToComment={handldReplyToComment}
                          />
                        );
                      })}
                    </div>
            ...
            >
              ...
              <div>
                {searchResult.generatorRole === "STUDENT" && (
                  <Link
                    title={"This analogy was generated by a STUDENT role user"}
                  >
                    <div
                      className="nameplate"
                      style={{
                        background: "linear-gradient(145deg, #da8a67, #c87551)",
                        marginLeft: "1rem",
                        marginBottom: "0.5rem",
                      }}
                    >
                ...
                {searchResult.generatorRole === "TEACHER" && (
                  <Link
                    title={"This analogy was generated by a TEACHER role user"}
                  >
                    <div
                      className="nameplate"
                      style={{
                ...
                {searchResult.generatorRole === "EXPERT" && (
                  <Link
                    title={"This analogy was generated by an EXPERT role user"}
                  >
                    <div
                      className="nameplate"
                      style={{
                        background: "linear-gradient(145deg, #ffd700, #ffae42)",
                        marginLeft: "1rem",
                        marginBottom: "0.5rem",
                      }}
                    >
                ...
                >
                  <div
                    className="nameplate"
                    style={{
                      background: "linear-gradient(145deg, #b4e391, #61c419)",
                      marginLeft: "1rem",
                      marginBottom: "0.5rem",
                    }}
                  >
              ...
              <div style={{ backgroundColor: "#a9dafa", padding: "1%" }}>
                <Card.Title style={{ display: "flex", alignItems: "center" }}>
                  ...
                  {searchResult.generatorRole === "STUDENT" && (
                    <Link
                      title={
                        "This analogy was generated by a STUDENT role user"
                      }
                    >
                      <div
                        className="nameplate"
                        style={{
                          background:
                            "linear-gradient(145deg, #da8a67, #c87551)",
                          marginLeft: "1rem",
                          marginBottom: "0.5rem",
                        }}
                      >
                  ...
                  {searchResult.generatorRole === "TEACHER" && (
                    <Link
                      title={
                        "This analogy was generated by a TEACHER role user"
                      }
                    >
                      <div
                        className="nameplate"
                        style={{
                          background:
                            "linear-gradient(145deg, #e6e6e6, #b3b3b3)",
                          marginLeft: "1rem",
                          marginBottom: "0.5rem",
                        }}
                      >
                  ...
                  {searchResult.generatorRole === "EXPERT" && (
                    <Link
                      title={
                        "This analogy was generated by an EXPERT role user"
                      }
                    >
                      <div
                        className="nameplate"
                        style={{
                          background:
                            "linear-gradient(145deg, #ffd700, #ffae42)",
                          marginLeft: "1rem",
                          marginBottom: "0.5rem",
                        }}
                      >
