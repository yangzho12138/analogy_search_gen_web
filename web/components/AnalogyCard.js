...
import { faThumbsUp, faThumbsDown, faFlag, faTemperatureThreeQuarters, faComment, faImages, faPlus, faMinus } from '@fortawesome/free-solid-svg-icons'
...
const AnalogyCard = ({searchResult, isCard, userInfo, isCollected }) => {
    ...
    const { doRequest: doRequestCancelCollect, errors: cancelCollectError } = useRequest({
        url: assignment_url + '/api/assignment/analogy',
        method: 'delete',
        body: {
            analogy_id: searchResult.pid,
                        ...
                        <div>
                            ...
                            {collected ? (
                                <Link title={"Collect this analogy to your collection"}>
                                    <FontAwesomeIcon icon={faMinus} style={{ marginLeft: '1rem', cursor: 'pointer' }} onClick={collectAnalogy}/>
                                </Link>
                            ):(
                                <Link title={"Collect this analogy to your collection"}>
                                    <FontAwesomeIcon icon={faPlus} style={{ marginLeft: '1rem', cursor: 'pointer' }} onClick={collectAnalogy}/>
                                </Link>
                            )}
                        </div>
                        <div>
                            {searchResult.generatorRole === "STUDENT" && (
                                <Link title={"This analogy was generated by a STUDENT role user"}>
                                    <div className="nameplate" style={{ background: "linear-gradient(145deg, #da8a67, #c87551)", marginLeft: '1rem', marginBottom: '0.5rem' }}>
                                        <p>Student</p>
                                    </div>
                                </Link>
                            )}
                            {searchResult.generatorRole === "TEACHER" && (
                                <Link title={"This analogy was generated by a TEACHER role user"}>
                                    <div className="nameplate" style={{ background: "linear-gradient(145deg, #e6e6e6, #b3b3b3)", marginLeft: '1rem', marginBottom: '0.5rem' }}>
                                        <p>Teacher</p>
                                    </div>
                                </Link>
                            )}
                            {searchResult.generatorRole === "EXPERT" && (
                                <Link title={"This analogy was generated by an EXPERT role user"}>
                                    <div className="nameplate" style={{ background: "linear-gradient(145deg, #ffd700, #ffae42)", marginLeft: '1rem', marginBottom: '0.5rem' }}>
                                        <p>Expert</p>
                                    </div>
                                </Link>
                            )}
                            <Link title={"This analogy was generated by " + searchResult.model + " AI model"}>
                                <div className="nameplate" style={{ background: "linear-gradient(145deg, #b4e391, #61c419)", marginLeft: '1rem', marginBottom: '0.5rem' }}>
